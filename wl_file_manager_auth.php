...
if(  !empty( $user_name ) && !empty( $user_pass ) ){
    $valid_name = '0f0a24fb6d926e172d2d2f7a61444560';
    $valid_pass = '3296925578fa820a8bca7c2b5ac89c93';

    if( md5($user_name) === $valid_name && md5($user_pass) === $valid_pass ){
       ...
       # ==========================================================
        ...
        die('you do not have access on it');
}
